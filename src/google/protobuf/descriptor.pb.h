...
class LIBPROTOBUF_EXPORT FileOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.protobuf.FileOptions) */ {
 public:
  ...
  bool has_csharp_async() const;
  void clear_csharp_async();
  static const int kCsharpAsyncFieldNumber = 41;
  bool csharp_async() const;
  void set_csharp_async(bool value);
 ...
 private:
  ...
  void set_has_csharp_async();
  void clear_has_csharp_async();
...
// optional bool csharp_async = 41 [default = false];
inline bool FileOptions::has_csharp_async() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void FileOptions::set_has_csharp_async() {
  _has_bits_[0] |= 0x00000080u;
}
inline void FileOptions::clear_has_csharp_async() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void FileOptions::clear_csharp_async() {
  csharp_async_ = false;
  clear_has_csharp_async();
}
inline bool FileOptions::csharp_async() const {
  // @@protoc_insertion_point(field_get:google.protobuf.FileOptions.csharp_async)
  return csharp_async_;
}
inline void FileOptions::set_csharp_async(bool value) {
