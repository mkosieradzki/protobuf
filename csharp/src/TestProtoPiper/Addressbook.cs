...
namespace Google.Protobuf.Examples.AddressBook {
  ...
  public sealed partial class Person : pb::IMessage<Person>, IMessageSupportsSpan, pb::IEfficientMessage {
    ...
    public void MergeFrom(ref ReadOnlySequence<byte> buffer) {
      ...
      while ((tag = CodedInputParser.ReadTag(ref buffer)) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            Name = CompatUtils.DecodeUtf8String(CodedInputParser.ReadLengthDelimited(ref buffer));
            break;
          }
          case 16: {
            Id = CodedInputParser.ReadInt32(ref buffer);
            break;
          }
          case 26: {
            Email = CompatUtils.DecodeUtf8String(CodedInputParser.ReadLengthDelimited(ref buffer));
            break;
          }
          case 34: {
     ...
     [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void MergeFrom(ref ReadOnlySpan<byte> span) {
      uint tag;
      while ((tag = CodedInputSpanParser.ReadTag(ref span)) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            Name = CompatUtils.DecodeUtf8String(CodedInputSpanParser.ReadLengthDelimited(ref span));
            break;
          }
          case 16: {
            Id = CodedInputSpanParser.ReadInt32(ref span);
            break;
          }
          case 26: {
            Email = CompatUtils.DecodeUtf8String(CodedInputSpanParser.ReadLengthDelimited(ref span));
            break;
          }
          case 34: {
                            throw new NotImplementedException();
    ...
    public void MergeFrom(ref ReadOnlySequence<byte> buffer) {
      ...
      while ((tag = CodedInputParser.ReadTag(ref buffer)) != 0) {
        switch(tag) {
          ...
          case 10: {
            var obj = new Person();
            var nestedBuffer = CodedInputParser.ReadLengthDelimited(ref buffer);
