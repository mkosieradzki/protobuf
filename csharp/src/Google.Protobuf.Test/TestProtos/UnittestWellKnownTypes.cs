      ...
      while ((tag = await input.ReadTagAsync(cancellationToken).ConfigureAwait(false)) != 0) {
        switch(tag) {
          ...
          case 10: {
            ...
            await input.ReadMessageAsync(anyField_, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 18: {
            if (apiField_ == null) {
            ...
            await input.ReadMessageAsync(apiField_, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 26: {
            if (durationField_ == null) {
            ...
            await input.ReadMessageAsync(durationField_, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 34: {
            if (emptyField_ == null) {
            ...
            await input.ReadMessageAsync(emptyField_, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 42: {
            if (fieldMaskField_ == null) {
            ...
            await input.ReadMessageAsync(fieldMaskField_, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 50: {
            if (sourceContextField_ == null) {
            ...
            await input.ReadMessageAsync(sourceContextField_, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 58: {
            if (structField_ == null) {
            ...
            await input.ReadMessageAsync(structField_, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 66: {
            if (timestampField_ == null) {
            ...
            await input.ReadMessageAsync(timestampField_, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 74: {
            if (typeField_ == null) {
            ...
            await input.ReadMessageAsync(typeField_, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 82: {
            double? value = await _single_doubleField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            if (doubleField_ == null || value != 0D) {
              DoubleField = value;
            }
            break;
          ...
          case 90: {
            float? value = await _single_floatField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            if (floatField_ == null || value != 0F) {
              FloatField = value;
            }
            break;
          ...
          case 98: {
            long? value = await _single_int64Field_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            if (int64Field_ == null || value != 0L) {
              Int64Field = value;
            }
            break;
          ...
          case 106: {
            ulong? value = await _single_uint64Field_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            if (uint64Field_ == null || value != 0UL) {
              Uint64Field = value;
            }
            break;
          ...
          case 114: {
            int? value = await _single_int32Field_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            if (int32Field_ == null || value != 0) {
              Int32Field = value;
            }
            break;
          ...
          case 122: {
            uint? value = await _single_uint32Field_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            if (uint32Field_ == null || value != 0) {
              Uint32Field = value;
            }
            break;
          ...
          case 130: {
            bool? value = await _single_boolField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            if (boolField_ == null || value != false) {
              BoolField = value;
            }
            break;
          ...
          case 138: {
            string value = await _single_stringField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            if (stringField_ == null || value != "") {
              StringField = value;
            }
            break;
          ...
          case 146: {
            pb::ByteString value = await _single_bytesField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            if (bytesField_ == null || value != pb::ByteString.Empty) {
              BytesField = value;
            }
            break;
          ...
          case 154: {
            ...
            await input.ReadMessageAsync(valueField_, cancellationToken).ConfigureAwait(false);
            break;
          }
        }
      }
      ...
      while ((tag = await input.ReadTagAsync(cancellationToken).ConfigureAwait(false)) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            await anyField_.AddEntriesFromAsync(input, _repeated_anyField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 18: {
            await apiField_.AddEntriesFromAsync(input, _repeated_apiField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 26: {
            await durationField_.AddEntriesFromAsync(input, _repeated_durationField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 34: {
            await emptyField_.AddEntriesFromAsync(input, _repeated_emptyField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 42: {
            await fieldMaskField_.AddEntriesFromAsync(input, _repeated_fieldMaskField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 50: {
            await sourceContextField_.AddEntriesFromAsync(input, _repeated_sourceContextField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 58: {
            await structField_.AddEntriesFromAsync(input, _repeated_structField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 66: {
            await timestampField_.AddEntriesFromAsync(input, _repeated_timestampField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 74: {
            await typeField_.AddEntriesFromAsync(input, _repeated_typeField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 82: {
            await doubleField_.AddEntriesFromAsync(input, _repeated_doubleField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 90: {
            await floatField_.AddEntriesFromAsync(input, _repeated_floatField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 98: {
            await int64Field_.AddEntriesFromAsync(input, _repeated_int64Field_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 106: {
            await uint64Field_.AddEntriesFromAsync(input, _repeated_uint64Field_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 114: {
            await int32Field_.AddEntriesFromAsync(input, _repeated_int32Field_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 122: {
            await uint32Field_.AddEntriesFromAsync(input, _repeated_uint32Field_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 130: {
            await boolField_.AddEntriesFromAsync(input, _repeated_boolField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 138: {
            await stringField_.AddEntriesFromAsync(input, _repeated_stringField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 146: {
            await bytesField_.AddEntriesFromAsync(input, _repeated_bytesField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
        }
      }
    ...
    public async stt::Task MergeFromAsync(pb::CodedInputStream input, st::CancellationToken cancellationToken) {
      ...
      while ((tag = await input.ReadTagAsync(cancellationToken).ConfigureAwait(false)) != 0) {
        switch(tag) {
          ...
          case 82: {
            DoubleField = await _oneof_doubleField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 90: {
            FloatField = await _oneof_floatField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 98: {
            Int64Field = await _oneof_int64Field_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 106: {
            Uint64Field = await _oneof_uint64Field_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 114: {
            Int32Field = await _oneof_int32Field_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 122: {
            Uint32Field = await _oneof_uint32Field_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 130: {
            BoolField = await _oneof_boolField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 138: {
            StringField = await _oneof_stringField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 146: {
            BytesField = await _oneof_bytesField_codec.ReadAsync(input, cancellationToken).ConfigureAwait(false);
            break;
          }
        }
      }
      ...
      while ((tag = await input.ReadTagAsync(cancellationToken).ConfigureAwait(false)) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            await anyField_.AddEntriesFromAsync(input, _map_anyField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 18: {
            await apiField_.AddEntriesFromAsync(input, _map_apiField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 26: {
            await durationField_.AddEntriesFromAsync(input, _map_durationField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 34: {
            await emptyField_.AddEntriesFromAsync(input, _map_emptyField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 42: {
            await fieldMaskField_.AddEntriesFromAsync(input, _map_fieldMaskField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 50: {
            await sourceContextField_.AddEntriesFromAsync(input, _map_sourceContextField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 58: {
            await structField_.AddEntriesFromAsync(input, _map_structField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 66: {
            await timestampField_.AddEntriesFromAsync(input, _map_timestampField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 74: {
            await typeField_.AddEntriesFromAsync(input, _map_typeField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 82: {
            await doubleField_.AddEntriesFromAsync(input, _map_doubleField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 90: {
            await floatField_.AddEntriesFromAsync(input, _map_floatField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 98: {
            await int64Field_.AddEntriesFromAsync(input, _map_int64Field_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 106: {
            await uint64Field_.AddEntriesFromAsync(input, _map_uint64Field_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 114: {
            await int32Field_.AddEntriesFromAsync(input, _map_int32Field_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 122: {
            await uint32Field_.AddEntriesFromAsync(input, _map_uint32Field_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 130: {
            await boolField_.AddEntriesFromAsync(input, _map_boolField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 138: {
            await stringField_.AddEntriesFromAsync(input, _map_stringField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
          case 146: {
            await bytesField_.AddEntriesFromAsync(input, _map_bytesField_codec, cancellationToken).ConfigureAwait(false);
            break;
          }
        }
      }
